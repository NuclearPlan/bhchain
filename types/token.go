...
const (
	...
	NativeUsdtToken        = "usdt"
	NativeUsdtTokenDecimal = 18
...
type BaseToken struct {
	...
	MapToken    bool   `json:"map_token" yaml:"map_token"`
}
...
func (t *BaseToken) String() string {
	...
	Weight:%v
    IsMapToken:%v
	`, t.Name, t.Symbol, t.Issuer, t.Chain, t.SendEnabled, t.Decimals, t.TotalSupply, t.Weight, t.IsMapToken)
}
...
func (t *BaseToken) IsMapToken() bool {
	return t.MapToken
}
...
type IBCToken struct {
	...
	MappingSymbol      Symbol    `json:"mapping_symbol" yaml:"mapping_symbol"`
}
...
func (t *IBCToken) String() string {
	...
	`, t.Name, t.Symbol, t.Issuer, t.Chain, t.TokenType, t.SendEnabled, t.DepositEnabled,
		...
		t.OpCUSysTransferNum, t.GasLimit, t.GasPrice, t.Confirmations, t.IsNonceBased, t.NeedCollectFee, t.MappingSymbol)
}
...
func (t *IBCToken) SysTransferAmount(gasPrice Int) Int {
	return gasPrice.Mul(t.GasLimit).Mul(t.SysTransferNum)
}

func (t *IBCToken) OpCUSysTransferAmount(gasPrice Int) Int {
	return gasPrice.Mul(t.GasLimit).Mul(t.OpCUSysTransferNum)
}
...
func CalcAmountWithDecimalDiff(amount Int, srcDecimal, dstDecmial uint64) Int {
	if srcDecimal == dstDecmial {
		return amount
	}

	return amount.Mul(NewIntWithDecimal(1, int(srcDecimal))).Quo(NewIntWithDecimal(1, int(dstDecmial)))
}
