...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/bluehelix-chain/bhchain/tree/master/CONTRIBUTING.md)
...
[master](https://github.com/bluehelix-chain/bhchain/tree/master/docs).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/bluehelix-chain/bhchain/blob/master/client/lcd/swagger-ui/swagger.yaml)
