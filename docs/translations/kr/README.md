...
>*NOTE*: 코스모스 SDK 지원 문서의 완성도와 정확성을 높이기 위해 해당 문서는 꾸준히 업데이트 되고 있습니다. 혹시 오류나 제안사항이 있으시다면 [코스모스 포럼](https://forum.cosmos.network) 또는 [깃허브 이슈를](https://github.com/bluehelix-chain/bhchain/issues/new) 통해서 알려주시면 감사하겠습니다.
...
코스모스 도큐멘테이션 또는 코드 업데이트 규칙에 관련해서는 [이 파일](https://github.com/bluehelix-chain/bhchain/blob/master/docs/DOCS_README.md)을 참고해주세요.
