...
- [SDK API 参考](https://godoc.org/github.com/bluehelix-chain/bhchain): Cosmos SDK Godocs 文档 。
...
参考 [文档说明](https://github.com/bluehelix-chain/bhchain/blob/master/docs/DOCS_README.md) 了解构建细节及更新时注意事项。
