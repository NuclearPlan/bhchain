...
* [\#4387](https://github.com/bluehelix-chain/bhchain/issues/4387) Refactor the usage of tags (now called events) to reflect the
...
* [\#3928](https://github.com/bluehelix-chain/bhchain/issues/3928) remove staking references from types package
...
* [\#3966](https://github.com/bluehelix-chain/bhchain/issues/3966) fixed multiple assigns to action tags
...
* [\#3937](https://github.com/bluehelix-chain/bhchain/issues/3937) Implement community pool querier.
...
* SDK
  ...
  * [staking] [\#3289](https://github.com/bluehelix-chain/bhchain/issues/3289) misc renames:
    * `Validator.UnbondingMinTime` -> `Validator.UnbondingCompletionTime`
    * `Delegation` -> `Value` in `MsgCreateValidator` and `MsgDelegate`
    * `MsgBeginUnbonding` -> `MsgUndelegate`
 ...
 * [\#2610](https://github.com/bluehelix-chain/bhchain/issues/2610) [x/stake] Block redelegation to and from the same validator
...
* SDK
    ...
    * [x/stake] [\#2500](https://github.com/bluehelix-chain/bhchain/issues/2500) Block conflicting redelegations until we add an index
...
* Gaia CLI  (`gaiacli`)
  ...
  * [cli] [\#2204](https://github.com/bluehelix-chain/bhchain/issues/2204) Support generating and broadcasting messages with multiple signatures via command line:
...
* SDK
  ...
  * [simulation] [\#1924](https://github.com/bluehelix-chain/bhchain/issues/1924) Add benchmarking capabilities, with makefile commands "test_sim_gaia_benchmark, test_sim_gaia_profile"
  * [simulation] [\#2349](https://github.com/bluehelix-chain/bhchain/issues/2349) Add time-based future scheduled operations to simulator
  * [x/auth] [\#2376](https://github.com/bluehelix-chain/bhchain/issues/2376) Remove FeePayer() from StdTx
  * [x/stake] [\#1672](https://github.com/bluehelix-chain/bhchain/issues/1672) Implement
...
* Gaia REST API (`gaiacli advanced rest-server`)
    * [x/stake] [\#2000](https://github.com/bluehelix-chain/bhchain/issues/2000) Added tests for new staking endpoints
    * [gaia-lite] [\#2445](https://github.com/bluehelix-chain/bhchain/issues/2445) Standarized REST error responses
    * [gaia-lite] Added example to Swagger specification for /keys/seed.
    * [x/stake] Refactor REST utils

* Gaia CLI  (`gaiacli`)
    * [cli] [\#2060](https://github.com/bluehelix-chain/bhchain/issues/2060) removed `--select` from `block` command
    * [cli] [\#2128](https://github.com/bluehelix-chain/bhchain/issues/2128) fixed segfault when exporting directly after `gaiad init`
    * [cli] [\#1255](https://github.com/bluehelix-chain/bhchain/issues/1255) open KeyBase in read-only mode
     for query-purpose CLI commands
    * [docs] Added commands for querying governance deposits, votes and tally

* Gaia
    * [x/stake] [#2023](https://github.com/bluehelix-chain/bhchain/pull/2023) Terminate iteration loop in `UpdateBondedValidators` and `UpdateBondedValidatorsFull` when the first revoked validator is encountered and perform a sanity check.
    * [x/auth] Signature verification's gas cost now accounts for pubkey type. [#2046](https://github.com/tendermint/tendermint/pull/2046)
    * [x/stake] [x/slashing] Ensure delegation invariants to jailed validators [#1883](https://github.com/bluehelix-chain/bhchain/issues/1883).
    * [x/stake] Improve speed of GetValidator, which was shown to be a performance bottleneck. [#2046](https://github.com/tendermint/tendermint/pull/2200)
    * [x/stake] [\#2435](https://github.com/bluehelix-chain/bhchain/issues/2435) Improve memory efficiency of getting the various store keys
    * [genesis] [\#2229](https://github.com/bluehelix-chain/bhchain/issues/2229) Ensure that there are no duplicate accounts or validators in the genesis state.
    * [genesis] [\#2450](https://github.com/bluehelix-chain/bhchain/issues/2450) Validate staking genesis parameters.
    * Add SDK validation to `config.toml` (namely disabling `create_empty_blocks`) [\#1571](https://github.com/bluehelix-chain/bhchain/issues/1571)
    * [\#1941](https://github.com/bluehelix-chain/bhchain/issues/1941)(https://github.com/bluehelix-chain/bhchain/issues/1941) Version is now inferred via `git describe --tags`.
    * [x/distribution] [\#1671](https://github.com/bluehelix-chain/bhchain/issues/1671) add distribution types and tests

* SDK
    * [tools] Make get_vendor_deps deletes `.vendor-new` directories, in case scratch files are present.
    * [spec] Added simple piggy bank distribution spec
    * [cli] [\#1632](https://github.com/bluehelix-chain/bhchain/issues/1632) Add integration tests to ensure `basecoind init && basecoind` start sequences run successfully for both `democoin` and `basecoin` examples.
    * [store] Speedup IAVL iteration, and consequently everything that requires IAVL iteration. [#2143](https://github.com/bluehelix-chain/bhchain/issues/2143)
    * [store] [\#1952](https://github.com/bluehelix-chain/bhchain/issues/1952), [\#2281](https://github.com/bluehelix-chain/bhchain/issues/2281) Update IAVL dependency to v0.11.0
    * [simulation] Make timestamps randomized [#2153](https://github.com/bluehelix-chain/bhchain/pull/2153)
    * [simulation] Make logs not just pure strings, speeding it up by a large factor at greater block heights [\#2282](https://github.com/bluehelix-chain/bhchain/issues/2282)
    * [simulation] Add a concept of weighting the operations [\#2303](https://github.com/bluehelix-chain/bhchain/issues/2303)
    * [simulation] Logs get written to file if large, and also get printed on panics [\#2285](https://github.com/bluehelix-chain/bhchain/issues/2285)
    * [simulation] Bank simulations now makes testing auth configurable [\#2425](https://github.com/bluehelix-chain/bhchain/issues/2425)
    * [gaiad] [\#1992](https://github.com/bluehelix-chain/bhchain/issues/1992) Add optional flag to `gaiad testnet` to make config directory of daemon (default `gaiad`) and cli (default `gaiacli`) configurable
    * [x/stake] Add stake `Queriers` for Gaia-lite endpoints. This increases the staking endpoints performance by reusing the staking `keeper` logic for queries. [#2249](https://github.com/bluehelix-chain/bhchain/pull/2149)
    * [store] [\#2017](https://github.com/bluehelix-chain/bhchain/issues/2017) Refactor
    gas iterator gas consumption to only consume gas for iterator creation and `Next`
    calls which includes dynamic consumption of value length.
    * [types/decimal] [\#2378](https://github.com/bluehelix-chain/bhchain/issues/2378) - Added truncate functionality to decimal
    * [client] [\#1184](https://github.com/bluehelix-chain/bhchain/issues/1184) Remove unused `client/tx/sign.go`.
    * [tools] [\#2464](https://github.com/bluehelix-chain/bhchain/issues/2464) Lock binary dependencies to a specific version
    * #2573 [x/distribution] add accum invariance

BUG FIXES

* Gaia CLI  (`gaiacli`)
    * [cli] [\#1997](https://github.com/bluehelix-chain/bhchain/issues/1997) Handle panics gracefully when `gaiacli stake {delegation,unbond}` fail to unmarshal delegation.
    * [cli] [\#2265](https://github.com/bluehelix-chain/bhchain/issues/2265) Fix JSON formatting of the `gaiacli send` command.
    * [cli] [\#2547](https://github.com/bluehelix-chain/bhchain/issues/2547) Mark --to and --amount as required flags for `gaiacli tx send`.

* Gaia
  * [x/stake] Return correct Tendermint validator update set on `EndBlocker` by not
  including non previously bonded validators that have zero power. [#2189](https://github.com/bluehelix-chain/bhchain/issues/2189)
  * [docs] Fixed light client section links

* SDK
    * [\#1988](https://github.com/bluehelix-chain/bhchain/issues/1988) Make us compile on OpenBSD (disable ledger) [#1988] (https://github.com/bluehelix-chain/bhchain/issues/1988)
    * [\#2105](https://github.com/bluehelix-chain/bhchain/issues/2105) Fix DB Iterator leak, which may leak a go routine.
    * [ledger] [\#2064](https://github.com/bluehelix-chain/bhchain/issues/2064) Fix inability to sign and send transactions via the LCD by
    loading a Ledger device at runtime.
    * [\#2158](https://github.com/bluehelix-chain/bhchain/issues/2158) Fix non-deterministic ordering of validator iteration when slashing in `gov EndBlocker`
    * [simulation] [\#1924](https://github.com/bluehelix-chain/bhchain/issues/1924) Make simulation stop on SIGTERM
    * [\#2388](https://github.com/bluehelix-chain/bhchain/issues/2388) Remove dependency on deprecated tendermint/tmlibs repository.
    * [\#2416](https://github.com/bluehelix-chain/bhchain/issues/2416) Refactored `InitializeTestLCD` to properly include proposing validator in genesis state.
...
* Gaia REST API (`gaiacli advanced rest-server`)
  - [x/stake] [\#1880](https://github.com/bluehelix-chain/bhchain/issues/1880) More REST-ful endpoints (large refactor)
  - [x/slashing] [\#1866](https://github.com/bluehelix-chain/bhchain/issues/1866) `/slashing/signing_info` takes cosmosvalpub instead of cosmosvaladdr
...
* Gaia CLI  (`gaiacli`)
  ...
  -  [x/stake] [\#1828](https://github.com/bluehelix-chain/bhchain/issues/1828) Force user to specify amount on create-validator command by removing default
  -  [x/gov] Change `--proposalID` to `--proposal-id`
  -  [x/stake, x/gov] [\#1606](https://github.com/bluehelix-chain/bhchain/issues/1606) Use `--from` instead of adhoc flags like `--address-validator`
        and `--proposer` to indicate the sender address.
  -  [\#1551](https://github.com/bluehelix-chain/bhchain/issues/1551) Remove `--name` completely
...
* Gaia
  ...
  - [x/gov] [\#1781](https://github.com/bluehelix-chain/bhchain/issues/1781) Added tags sub-package, changed tags to use dash-case
  - [x/gov] [\#1688](https://github.com/bluehelix-chain/bhchain/issues/1688) Governance parameters are now stored in globalparams store
  - [x/gov] [\#1859](https://github.com/bluehelix-chain/bhchain/issues/1859) Slash validators who do not vote on a proposal
  - [x/gov] [\#1914](https://github.com/bluehelix-chain/bhchain/issues/1914) added TallyResult type that gets stored in Proposal after tallying is finished
...
* SDK
  ...
  - [client] [\#1551](https://github.com/bluehelix-chain/bhchain/issues/1551): Refactored `CoreContext` to `TxContext` and `QueryContext`
...
* Tendermint
    ...
    - v0.23.0 -> See
      ...
      and [SDK PR](https://github.com/bluehelix-chain/bhchain/pull/1927)
...
* Gaia CLI  (`gaiacli`)
    ...
    - [x/stake] [\#2043](https://github.com/bluehelix-chain/bhchain/issues/2043) Added staking query cli cmds for unbonding-delegations and redelegations
...
* SDK
  ...
  - [store] [\#1481](https://github.com/bluehelix-chain/bhchain/issues/1481) Add transient store
...
* Gaia
  - [spec] [\#967](https://github.com/bluehelix-chain/bhchain/issues/967) Inflation and distribution specs drastically improved
  - [x/gov] [\#1773](https://github.com/bluehelix-chain/bhchain/issues/1773) Votes on a proposal can now be queried
  - [x/gov] Initial governance parameters can now be set in the genesis file
  - [x/stake] [\#1815](https://github.com/bluehelix-chain/bhchain/issues/1815) Sped up the processing of `EditValidator` txs.
  - [config] [\#1930](https://github.com/bluehelix-chain/bhchain/issues/1930) Transactions indexer indexes all tags by default.
  - [ci] [#2057](https://github.com/bluehelix-chain/bhchain/pull/2057) Run `make localnet-start` on every commit and ensure network reaches at least 10 blocks

* SDK
  - [baseapp] [\#1587](https://github.com/bluehelix-chain/bhchain/issues/1587) Allow any alphanumeric character in route
  - [baseapp] Allow any alphanumeric character in route
  - [tools] Remove `rm -rf vendor/` from `make get_vendor_deps`
  - [x/auth] Recover ErrorOutOfGas panic in order to set sdk.Result attributes correctly
  - [x/auth] [\#2376](https://github.com/bluehelix-chain/bhchain/issues/2376) No longer runs any signature in a multi-msg, if any account/sequence number is wrong.
  - [x/auth] [\#2376](https://github.com/bluehelix-chain/bhchain/issues/2376) No longer charge gas for subtracting fees
  - [x/bank] Unit tests are now table-driven
  - [tests] Add tests to example apps in docs
  - [tests] Fixes ansible scripts to work with AWS too
  - [tests] [\#1806](https://github.com/bluehelix-chain/bhchain/issues/1806) CLI tests are now behind the build flag 'cli_test', so go test works on a new repo

BUG FIXES

* Gaia CLI  (`gaiacli`)
  -  [\#1766](https://github.com/bluehelix-chain/bhchain/issues/1766) Fixes bad example for keybase identity
  -  [x/stake] [\#2021](https://github.com/bluehelix-chain/bhchain/issues/2021) Fixed repeated CLI commands in staking

* Gaia
  - [x/stake] [#2077](https://github.com/bluehelix-chain/bhchain/pull/2077) Fixed invalid cliff power comparison
  - [\#1804](https://github.com/bluehelix-chain/bhchain/issues/1804) Fixes gen-tx genesis generation logic temporarily until upstream updates
  - [\#1799](https://github.com/bluehelix-chain/bhchain/issues/1799) Fix `gaiad export`
  - [\#1839](https://github.com/bluehelix-chain/bhchain/issues/1839) Fixed bug where intra-tx counter wasn't set correctly for genesis validators
  - [x/stake] [\#1858](https://github.com/bluehelix-chain/bhchain/issues/1858) Fixed bug where the cliff validator was not updated correctly
  - [tests] [\#1675](https://github.com/bluehelix-chain/bhchain/issues/1675) Fix non-deterministic `test_cover`
  - [tests] [\#1551](https://github.com/bluehelix-chain/bhchain/issues/1551) Fixed invalid LCD test JSON payload in `doIBCTransfer`
  - [basecoin] Fixes coin transaction failure and account query [discussion](https://forum.cosmos.network/t/unmarshalbinarybare-expected-to-read-prefix-bytes-75fbfab8-since-it-is-registered-concrete-but-got-0a141dfa/664/6)
  - [x/gov] [\#1757](https://github.com/bluehelix-chain/bhchain/issues/1757) Fix VoteOption conversion to String
...
*  [\#1797](https://github.com/bluehelix-chain/bhchain/issues/1797) Fix off-by-one error in slashing for downtime
*  [\#1787](https://github.com/bluehelix-chain/bhchain/issues/1787) Fixed bug where Tally fails due to revoked/unbonding validator
*  [\#1666](https://github.com/bluehelix-chain/bhchain/issues/1666) Add intra-tx counter to the genesis validators
...
BUG FIXES
* [\#1630](https://github.com/bluehelix-chain/bhchain/issues/1630) - redelegation nolonger removes tokens from the delegator liquid account
* [keys] [\#1629](https://github.com/bluehelix-chain/bhchain/issues/1629) - updating password no longer asks for a new password when the first entered password was incorrect
...
BUG FIXES
* [x/slashing] [\#1510](https://github.com/bluehelix-chain/bhchain/issues/1510) Unrevoked validators cannot un-revoke themselves
* [x/stake] [\#1513](https://github.com/bluehelix-chain/bhchain/issues/1513) Validators slashed to zero power are unbonded and removed from the store
* [x/stake] [\#1567](https://github.com/bluehelix-chain/bhchain/issues/1567) Validators decreased in power but not unbonded are now updated in Tendermint
...
* [\#872](https://github.com/bluehelix-chain/bhchain/issues/872)  - recovery phrases no longer all end in `abandon`
* [\#887](https://github.com/bluehelix-chain/bhchain/issues/887)  - limit the size of rationals that can be passed in from user input
* [\#1052](https://github.com/bluehelix-chain/bhchain/issues/1052) - Make all now works
* [\#1258](https://github.com/bluehelix-chain/bhchain/issues/1258) - printing big.rat's can no longer overflow int64
* [\#1259](https://github.com/bluehelix-chain/bhchain/issues/1259) - fix bug where certain tests that could have a nil pointer in defer
* [\#1343](https://github.com/bluehelix-chain/bhchain/issues/1343) - fixed unnecessary parallelism in CI
* [\#1353](https://github.com/bluehelix-chain/bhchain/issues/1353) - CLI: Show pool shares fractions in human-readable format
* [\#1367](https://github.com/bluehelix-chain/bhchain/issues/1367) - set ChainID in InitChain
* [\#1461](https://github.com/bluehelix-chain/bhchain/issues/1461) - CLI tests now no longer reset your local environment data
* [\#1505](https://github.com/bluehelix-chain/bhchain/issues/1505) - `gaiacli stake validator` no longer panics if validator doesn't exist
* [\#1565](https://github.com/bluehelix-chain/bhchain/issues/1565) - fix cliff validator persisting when validator set shrinks from max
* [\#1287](https://github.com/bluehelix-chain/bhchain/issues/1287) - prevent zero power validators at genesis
* [x/stake] fix bug when unbonding/redelegating using `--shares-percent`
* [\#1010](https://github.com/bluehelix-chain/bhchain/issues/1010) - two validators can't bond with the same pubkey anymore
...
FIXES
* Fixes consensus fault on testnet - see postmortem [here](https://github.com/bluehelix-chain/bhchain/issues/1197#issuecomment-396823021)
...
[Unreleased]: https://github.com/bluehelix-chain/bhchain/compare/v0.37.2...HEAD
[v0.37.2]: https://github.com/bluehelix-chain/bhchain/releases/tag/v0.37.2
[v0.37.1]: https://github.com/bluehelix-chain/bhchain/releases/tag/v0.37.1
[v0.37.0]: https://github.com/bluehelix-chain/bhchain/releases/tag/v0.37.0
[v0.36.0]: https://github.com/bluehelix-chain/bhchain/releases/tag/v0.36.0
