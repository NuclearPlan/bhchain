...
import (
	...
	authsim "github.com/bluehelix-chain/bhchain/x/custodianunit/simulation"
	distr "github.com/bluehelix-chain/bhchain/x/distribution"
	distrsim "github.com/bluehelix-chain/bhchain/x/distribution/simulation"
	...
	paramsim "github.com/bluehelix-chain/bhchain/x/params/simulation"
	"github.com/bluehelix-chain/bhchain/x/simulation"
	"github.com/bluehelix-chain/bhchain/x/slashing"
	slashingsim "github.com/bluehelix-chain/bhchain/x/slashing/simulation"
	"github.com/bluehelix-chain/bhchain/x/staking"
	stakingsim "github.com/bluehelix-chain/bhchain/x/staking/simulation"
	...
	return []simulation.WeightedOperation{
		{
			...
			authsim.SimulateDeductFee(app.cuKeeper, app.transferKeeper, app.supplyKeeper),
		},
		//{
		//	func(_ *rand.Rand) int {
		//		var v int
		...
		//		return v
		//	}(nil),
		//	 transfer.SimulateMsgSend(app.transferKeeper, app.transferKeeper),
		//},
		//{
		//	func(_ *rand.Rand) int {
		//		var v int
		...
		},
		{
			...
			stakingsim.SimulateMsgCreateValidator(app.transferKeeper, app.stakingKeeper),
		},
		{
			func(_ *rand.Rand) int {
				var v int
		...
		},
		{
			...
			stakingsim.SimulateMsgDelegate(app.transferKeeper, app.stakingKeeper),
		},
		{
			func(_ *rand.Rand) int {
				var v int
		...
		},
		{
			...
			stakingsim.SimulateMsgBeginRedelegate(app.transferKeeper, app.stakingKeeper),
		},
		{
			func(_ *rand.Rand) int {
				var v int
...
func invariants(app *bhexapp) []sdk.Invariant {
	...
	// Ref: https://github.com/bluehelix-chain/bhchain/issues/4631
	if period == 1 {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/bluehelix-chain/bhchain/bhexapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
