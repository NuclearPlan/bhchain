...
import (
	...
	"github.com/bluehelix-chain/bhchain/x/evidence"

	"github.com/bluehelix-chain/bhchain/x/hrc10"
	"github.com/bluehelix-chain/bhchain/x/mapping"
	...
	bam "github.com/bluehelix-chain/bhchain/baseapp"
	...
	"github.com/bluehelix-chain/bhchain/x/crisis"
	"github.com/bluehelix-chain/bhchain/x/custodianunit"
	distr "github.com/bluehelix-chain/bhchain/x/distribution"
	...
	"github.com/bluehelix-chain/bhchain/x/ibcasset"
	"github.com/bluehelix-chain/bhchain/x/keygen"
	mappingclient "github.com/bluehelix-chain/bhchain/x/mapping/client"
	"github.com/bluehelix-chain/bhchain/x/mint"
	"github.com/bluehelix-chain/bhchain/x/openswap"
	"github.com/bluehelix-chain/bhchain/x/order"
	otypes "github.com/bluehelix-chain/bhchain/x/order/types"
	"github.com/bluehelix-chain/bhchain/x/params"
	paramsclient "github.com/bluehelix-chain/bhchain/x/params/client"
	"github.com/bluehelix-chain/bhchain/x/slashing"
	"github.com/bluehelix-chain/bhchain/x/staking"
	stakingclient "github.com/bluehelix-chain/bhchain/x/staking/client"
	"github.com/bluehelix-chain/bhchain/x/supply"
	"github.com/bluehelix-chain/bhchain/x/transfer"
	"github.com/bluehelix-chain/bhchain/x/upgrade"
	upgradeclient "github.com/bluehelix-chain/bhchain/x/upgrade/client"
)
...
var (
	...
	DefaultCLIHome = os.ExpandEnv("$HOME/.bhcli")

	// default home directories for the application daemon
	DefaultNodeHome = os.ExpandEnv("$HOME/.bhexchain")
	...
	maccPerms = map[string][]string{
		...
		openswap.BonusCollectorName:    nil,
...
func Newbhexapp(
	...
	app.mintKeeper = mint.NewKeeper(app.cdc, keys[mint.StoreKey], mintSubspace, &stakingKeeper, app.supplyKeeper, custodianunit.FeeCollectorName, openswap.BonusCollectorName)
	...
	app.openswapKeeper = openswap.NewKeeper(app.cdc, keys[openswap.StoreKey], &app.tokenKeeper, &app.receiptKeeper, app.supplyKeeper, app.transferKeeper, openswapSubspace, custodianunit.FeeCollectorName)
