...
```bash
go test -v --bench github.com/bluehelix-chain/bhchain/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/bluehelix-chain/bhchain/crypto/keys/mintkey
...
PASS
ok  	github.com/bluehelix-chain/bhchain/crypto/keys/mintkey	12.093s
```
