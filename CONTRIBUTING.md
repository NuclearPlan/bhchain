...
1. Either [open](https://github.com/bluehelix-chain/bhchain/issues/new/choose) or
   [find](https://github.com/bluehelix-chain/bhchain/issues) an issue you'd like to help with
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/bluehelix-chain/bhchain/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
`$GOPATH/src/github.com/bluehelix-chain/bhchain `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/bluehelix-chain/bhchain`)
...
### Development Procedure
  ...
  - create a development branch either on github.com/bluehelix-chain/bhchain, or your fork (using `git remote add origin`)
