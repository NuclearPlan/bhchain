...
import (
	...
	store "github.com/bluehelix-chain/bhchain/store/types"
...
func registerTestCodec(cdc *codec.Codec) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "bhexchain/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "bhexchain/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "bhexchain/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "bhexchain/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "bhexchain/baseapp/msgNoDecode", nil)
