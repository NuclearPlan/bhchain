...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(AddMappingProposal{}, "bhexchain/AddMappingProposal")
	govtypes.RegisterProposalType(ProposalTypeSwitchMapping)
	govtypes.RegisterProposalTypeCodec(SwitchMappingProposal{}, "bhexchain/SwitchMappingProposal")
}
