...
import (
	...
	evitypes "github.com/bluehelix-chain/bhchain/x/evidence/types"
	"github.com/bluehelix-chain/bhchain/x/gov"
	"github.com/bluehelix-chain/bhchain/x/ibcasset"
	ibcexported "github.com/bluehelix-chain/bhchain/x/ibcasset/exported"
...
func setupTestInput(t *testing.T) testInput {
	...
	cdc.RegisterConcrete(&testCU{}, "bhexchain/test/testCU", nil)
