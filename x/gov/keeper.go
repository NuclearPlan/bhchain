...
func (keeper Keeper) ProposalOnlyKeyNode(ctx sdk.Context) (b bool) {
	keeper.paramSpace.Get(ctx, ParamStoreKeyProposalOnlyKeyNode, &b)
	return
}
...
func (keeper Keeper) setProposalOnlyKeyNode(ctx sdk.Context, b bool) {
	keeper.paramSpace.Set(ctx, ParamStoreKeyProposalOnlyKeyNode, &b)
}
