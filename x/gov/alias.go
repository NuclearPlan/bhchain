...
// ALIASGEN: github.com/bluehelix-chain/bhchain/x/gov/types
package gov
...
const (
	...
	ParamProposalOnlyKeyNode     = types.ParamProposalOnlyKeyNode
...
var (
	...
	ParamStoreKeyProposalOnlyKeyNode = types.ParamStoreKeyProposalOnlyKeyNode
)
