...
const (
	...
	DefaultMaxKeyNodes uint16 = 8

	DefaultMaxCandidateKeyNodeHeartbeatInterval uint64 = 100
)

var (
	//Default min validator delegation, 10K HBC, HBC's precesion is 1^10-18.
	DefaultMinValidatorDelegation = sdk.NewIntWithDecimal(2, 22)

	// default min keynode delegation, 50K HBC
	DefaultMinKeyNodeDelegation = sdk.NewIntWithDecimal(5, 22)
)
