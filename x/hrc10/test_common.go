...
func setupTestEnv(t *testing.T) testEnv {
	...
	mk := mint.NewKeeper(cdc, keyMint, pk.Subspace(mint.DefaultParamspace), stakingKeeper, supplyKeeper, custodianunit.FeeCollectorName, openswap.BonusCollectorName)
