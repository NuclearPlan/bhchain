...
import (
	...
	cu "github.com/bluehelix-chain/bhchain/x/custodianunit"
	"github.com/bluehelix-chain/bhchain/x/custodianunit/internal"
...
func NewDummySupplyKeeper(cdc *codec.Codec, ak cu.CUKeeper, tk internal.TransferKeeper) DummySupplyKeeper {
	cdc.RegisterConcrete(&moduleAccount{}, "bhexchain/test/ModuleAccount", nil)
