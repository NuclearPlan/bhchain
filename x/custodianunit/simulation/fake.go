...
// SimulateDeductFee
func SimulateDeductFee(ak custodianunit.CUKeeper, tk transferkeeper.Keeper, supplyKeeper internal.SupplyKeeper) simulation.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context,
		...
		initCoins := tk.GetAllBalance(ctx, CU.Address)
		...
		spendableCoins := tk.GetAllBalance(ctx, CU.Address)
