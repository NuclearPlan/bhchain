...
import (
	...
	"github.com/bluehelix-chain/bhchain/base58"
...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(AddTokenProposal{}, "bhexchain/AddTokenProposal")
	govtypes.RegisterProposalType(ProposalTypeTokenParamsChange)
	govtypes.RegisterProposalTypeCodec(TokenParamsChangeProposal{}, "bhexchain/TokenParamsChangeProposal")
}
