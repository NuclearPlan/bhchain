...
import (
	...
	gov "github.com/bluehelix-chain/bhchain/x/gov/types"
)
...
func init() {
	...
	gov.RegisterProposalTypeCodec(&SoftwareUpgradeProposal{}, "bhexchain/SoftwareUpgradeProposal")
	gov.RegisterProposalType(ProposalTypeCancelSoftwareUpgrade)
	gov.RegisterProposalTypeCodec(&CancelSoftwareUpgradeProposal{}, "bhexchain/CancelSoftwareUpgradeProposal")
}
