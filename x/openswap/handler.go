...
func NewHandler(k Keeper) sdk.Handler {
	return func(ctx sdk.Context, msg sdk.Msg) sdk.Result {
		...
		case types.MsgClaimLPEarning:
			return handleMsgClaimLPEarning(ctx, k, msg)
		case types.MsgClaimTradeEarning:
			return handleMsgClaimTradeEarning(ctx, k, msg)
		default:
...
func handleMsgAddLiquidity(ctx sdk.Context, k Keeper, msg types.MsgAddLiquidity) sdk.Result {
	...
	minTokenAAmount, minTokenBAmount := msg.MinTokenAAmount, msg.MinTokenBAmount
	tokenAAmount, tokenBAmount := msg.TokenAAmount, msg.TokenBAmount
	...
	return k.AddLiquidity(ctx, msg.From, msg.DexID, tokenA, tokenB, tokenAAmount, tokenBAmount, minTokenAAmount, minTokenBAmount)
}
...
func handleMsgRemoveLiquidity(ctx sdk.Context, k Keeper, msg types.MsgRemoveLiquidity) sdk.Result {
	...
	return k.RemoveLiquidity(ctx, msg.From, msg.DexID, tokenA, tokenB, msg.Liquidity, minTokenAAmount, minTokenBAmount)
}
...
func handleMsgClaimLPEarning(ctx sdk.Context, k Keeper, msg types.MsgClaimLPEarning) sdk.Result {
	tokenA, tokenB, result := k.SortTokens(ctx, msg.TokenA, msg.TokenB)
	if !result.IsOK() {
		return result
	}
	return k.ClaimLPEarning(ctx, msg.From, msg.DexID, tokenA, tokenB)
}

func handleMsgClaimTradeEarning(ctx sdk.Context, k Keeper, msg types.MsgClaimTradeEarning) sdk.Result {
	tokenA, tokenB, result := k.SortTokens(ctx, msg.TokenA, msg.TokenB)
	if !result.IsOK() {
		return result
	}
	return k.ClaimTradeEarning(ctx, msg.From, msg.DexID, tokenA, tokenB)
}
