...
func (msg MsgAddLiquidity) ValidateBasic() sdk.Error {
	...
	if msg.TokenAAmount.LT(msg.MinTokenAAmount) || msg.TokenBAmount.LT(msg.MinTokenBAmount) {
		return sdk.ErrInvalidAmount("desired token amount should be larger than min token amount")
	}
	if !msg.TokenAAmount.IsPositive() || !msg.TokenBAmount.IsPositive() ||
		!msg.MinTokenAAmount.IsPositive() || !msg.MinTokenBAmount.IsPositive() {
...
func (msg MsgRemoveLiquidity) ValidateBasic() sdk.Error {
	...
	if !msg.MinTokenAAmount.IsPositive() || !msg.MinTokenBAmount.IsPositive() {
		return sdk.ErrInvalidAmount("token amount should be positive")
	}
	return nil
}
...
func (msg MsgClaimTradeEarning) Type() string {
	return TypeMsgClaimTradeEarning
}
