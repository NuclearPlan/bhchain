...
import (
	...
	"github.com/bluehelix-chain/bhchain/x/mock"
...
func getMockApp(t *testing.T, numGenAccs int, genState GenesisState, genAccs []custodianunit.CU) testInput {
	...
	keeper := NewKeeper(mApp.Cdc, keyMint, pk.Subspace(DefaultParamspace), sk, supplyKeeper, custodianunit.FeeCollectorName, openswap.BonusCollectorName)
